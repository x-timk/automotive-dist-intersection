...
\chapter{Validazione}
Tutti i requisiti specificati nel \Cref{ch:analysis} sono soddisfatti. Il sistema è stato testato con una simulazione in cui l'incrocio viene continuamente alimentato con nuovi veicoli. In particolare viene utilizzato la funzionalità dell'interfaccia \emph{AutoSpawn}, che effettua lo spawn di veicoli con rotta casuale ogni secondo.
