...
% auto:
% - interrogare sensore prossimità
% - non muoversi qualora ci sia una macchina ferma più avanti
% - conoscere posizione attuale (in generale l'intero suo perscorso)
% - poter riconoscere se si trova in prossimità di un incrocio/in un incrocio/in coda.
% - riconoscere eventuali macchine guaste davanti e richiedere intervento carro attrezzi
% - muoversi
% - poter inviare messaggi alle singole macchine o in broadcast in modo affidabile
% - essere in grado coordinarsi con le altre auto per attraversare incrocio

% environment:
% - mantenere coerente lo stato del grafo di descrizione dell'incrocio.
% - simulare intervento carro attrezzi (rimuove l'auto dal mondo fisico)
% - simulare risposta alle query del sensore prossimità dell'auto
% - simulare propagazione messaggio broadcast di un auto alle altre auto a portata wireless

% gui:
% - poter visualizzare lo stato dell'incrocio per monitorare il funzionamento
% - poter inserire nella simulazione nuove auto
% - mostare informazioni sui veicoli
